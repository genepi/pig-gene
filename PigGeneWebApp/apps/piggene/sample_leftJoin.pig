...
R4 = FOREACH R3 GENERATE R1::chrom, R1::pos, R1::id, R1::ref, R1::alt, R1::qual, R1::filt, R1::info, R1::format, R1::genotype, R1::persID, R2::id;
R5 = FILTER R4 BY R2::id is null;
R6 = FOREACH R5 GENERATE R1::chrom, R1::pos, R1::id, R1::ref, R1::alt, R1::qual, R1::filt, R1::info, R1::format, R1::genotype, R1::persID;
